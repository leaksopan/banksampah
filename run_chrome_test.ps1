...
Write-Host "Menjalankan Chrome Headless New..."
Start-Process $chromePath -ArgumentList "--remote-debugging-port=9222", "--user-data-dir=C:\Users\Msi_\AppData\Local\Google\Chrome\UserDataTest", "--headless=new", "--disable-gpu"
...
if (Test-Path $sourceFile) {
    ...
    Write-Host "Isi dari $testProfileDir"
    Get-ChildItem -Path $testProfileDir | Out-String | Write-Host
}
